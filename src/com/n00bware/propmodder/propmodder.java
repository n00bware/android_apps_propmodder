    ...
    msg.show();
      ...
      */ 
       ...
       super.onCreate(savedInstanceState);
        ...
        Toast.makeText(getBaseContext(), "mWifiScanPref", Toast.LENGTH_SHORT).show();
        ...
        Toast.makeText(getBaseContext(), "mLcdDensityPref", Toast.LENGTH_SHORT).show();
        ...
        Toast.makeText(getBaseContext(), "mMaxEventsPref", Toast.LENGTH_SHORT).show();
        ...
        Toast.makeText(getBaseContext(), "mUsbModePref", Toast.LENGTH_SHORT).show();
        ...
        Toast.makeText(getBaseContext(), "mRingDelayPref", Toast.LENGTH_SHORT).show();
        ...
        Toast.makeText(getBaseContext(), "mVmHeapsizePref", Toast.LENGTH_SHORT).show();
        }
	...
	if (newValue != null) {
          Log.i(TAG, "new preference selected: " + newValue);
            if (preference == mWifiScanPref) {
                ...
                Toast.makeText(getBaseContext(), "new values ", Toast.LENGTH_SHORT).show();
